...
import config from "/js/config.js?v=0.10.5"
import codec from "/js/structure.js?v=0.10.5"
import createColoredBadges from "/js/colors.js?v=0.10.5"
import createTimings from "/js/timings.js?v=0.10.5"
import resizeSVGs from "/js/resizeSVGs.js?v=0.10.5"
import createPlayer from "/js/player.js?v=0.10.5"
import Ω from "/js/dom.js?v=0.10.5"
