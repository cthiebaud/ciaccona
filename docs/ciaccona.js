...
import config from "/js/config.js?v=0.12.2"
import codec from "/js/structure.js?v=0.12.2"
import { createColoredBadges } from "/js/colors.js?v=0.12.2.2"
import createTimings from "/js/timings.js?v=0.12.2"
import resizeSVGs from "/js/resizeSVGs.js?v=0.12.2"
import createPlayer from "/js/player.js?v=0.12.2"
import Ω from "/js/dom.js?v=0.12.2"
