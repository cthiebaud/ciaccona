...
import config from "/js/config.js?v=0.12.3"
import codec from "/js/structure.js?v=0.12.3"
import { createColoredBadges } from "/js/colors.js?v=0.12.3"
import createTimings from "/js/timings.js?v=0.12.3"
import resizeSVGs from "/js/resizeSVGs.js?v=0.12.3"
import createPlayer from "/js/player.js?v=0.12.3"
import Ω from "/js/dom.js?v=0.12.3"
