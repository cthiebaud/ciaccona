      ...
      this.everything = function () {
         ...
         function gen_dh() {
            ...
            for (xi = 0; xi < _.xn; ++xi) {
               ...
               map.get(key(xi, _.yn - 1))._1bottom = line(_.height)
            }
         ...
         function gen_dv() {
            ...
            for (yi = 0; yi < _.yn; ++yi) {
               ...
               map.get(key(_.xn - 1, yi))._2right = line(_.width)
            }
            return str;
         }
               ...
               this.db = gen_db(); ((w, h) => {
                  ...
                  for (let yi = 0; yi < _.yn; yi++) {
                     for (let xi = 0; xi < _.xn; xi++) {
                        ...
                        const x = _.offset - 50 + xi * w / _.xn
                        const y = _.offset - 60 + yi * h / _.yn
                        const width = w / _.xn + 100
                        const height = h / _.yn + 120
                  ...
                  const bb2 = `${_.offset - bb.x} ${_.offset - bb.y} ${w * 2} ${h * 2}`
